"""
Django settings for filmreview project.
...
# create a TEMPLATES_DIR constant to build a path for subdirectory 'templates'
...
MIDDLEWARE = [
    ...
    # add whitenoise above all other middleware apart 
...
STATIC_URL = 'static/'
# build a path for our subdirectory static so we can link to files in 
# the static directory from a template. 
